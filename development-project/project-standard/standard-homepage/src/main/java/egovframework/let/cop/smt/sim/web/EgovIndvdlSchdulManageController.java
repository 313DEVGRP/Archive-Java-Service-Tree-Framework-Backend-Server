...
public class EgovIndvdlSchdulManageController {
    ...
    throws Exception {
		...
		****************************************************************** */
		...
		//System.out.println("schdulBgnde:::"+(String)listWeek.get(0));
		//System.out.println("schdulEndde:::"+(String)listWeek.get(listWeek.size()-1));
    ...
    throws Exception { 
        ...
        if(sCmd.equals("save")){
        	...
        	// 아이디 설정
			****************************************************************** */
    		indvdlSchdulManageVO.setFrstRegisterId((String)user.getUniqId());
    		indvdlSchdulManageVO.setLastUpdusrId((String)user.getUniqId());
    		/* *****************************************************************
        	// 첨부파일 관련 ID 생성 start....
			****************************************************************** */
