...
<%
  /**
  * @Class Name : EgovSmsCacheMgtSelect.jsp
  * @Description : 캐시 조회  템플릿 생성
...
<title>Cache Mgt(select template)</title>
...
function fn_egov_preview(){
	...
	if(fn_egov_checkValue()){
	    ...
	    frm.method="post";
	    frm.action="<c:url value='/ole/sms/selectCacheMgt.sms'/>";
...
<form:form commandName="mgtVO" id="mgtVO" name="mgtVO">
	<div id="h2_topnav"><h2><strong>캐시 관리 - 캐시조회 Template</strong></h2></div>
		  	<div id="datail_table">
				<table id="tbl" summary="Bean Id,Cache Name,Element,Key" class="">
				<caption>Cache Management - Select Template</caption>
				  <tr>
                    <th scope="row" width="40%">Bean Id</th>
                    <td colspan="3">
                    	<label for="beanId">
                  ...
                  <tr>
                    <th scope="row" width="40%">Cache Name</th>
                    <td colspan="3">
                    	<label for="cacheNm">
                  ...
                  <tr>
                    <th scope="row" width="40%">Element</th>
                    <th width="20%">Key</th>
                    <td> 
                    	<label for="cacheKey">
			...
			<div id="btn_style01">
				...
				<a title="코드템플릿 생성" href="/#" onclick="javascript:fn_egov_preview();return false;"><span>코드템플릿 생성</span></a>
			</div>
</form:form>
</div>
</div>
