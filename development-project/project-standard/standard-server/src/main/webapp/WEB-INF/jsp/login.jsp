...
<head>
    ...
    <style>
        ...
        @media only screen and (max-width: 640px) {
            ...
            .login_form {
            / / background: url("../images/border.png") no-repeat 247 px 41 px;
            }
...
<div class="wrap">
    ...
    <div class="login-form">
        ...
        <form:form class="login_form" name='loginForm' action="<c:url value='../j_spring_security_check' />"
                   method='POST'>
            <h1>Login Into Your Account</h1>
            <ul>
                <li>
                    <input type="text" class="textbox1" id="username" name="j_username" placeholder="Username"
                           required="">
        ...
        <div class="account">
            ...
            <div class="span">
                <c:url var="post_url" value="../auth/facebook?scope=email,user_about_me,user_birthday"/>
                <form:form name='facebookSocialloginForm'
                           action="${post_url}"
                           method='POST'>
            ...
            <div class="span1">
                <form:form name='TwitterSocialloginForm'
