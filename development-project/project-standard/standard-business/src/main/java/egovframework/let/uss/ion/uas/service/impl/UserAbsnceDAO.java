...
public class UserAbsnceDAO extends EgovAbstractDAO {
    /** Log Info */
	...
	public List<UserAbsnceVO> selectUserAbsnceList(UserAbsnceVO userAbsnceVO) throws Exception {
		return list("userAbsnceDAO.selectUserAbsnceList", userAbsnceVO);
	}
    ...
    public int selectUserAbsnceListTotCnt(UserAbsnceVO userAbsnceVO) throws Exception {
        return (Integer)getSqlMapClientTemplate().queryForObject("userAbsnceDAO.selectUserAbsnceListTotCnt", userAbsnceVO);
    }
	...
	public UserAbsnceVO selectUserAbsnce(UserAbsnceVO userAbsnceVO) throws Exception {
		return (UserAbsnceVO) selectByPk("userAbsnceDAO.selectUserAbsnce", userAbsnceVO);
	}
