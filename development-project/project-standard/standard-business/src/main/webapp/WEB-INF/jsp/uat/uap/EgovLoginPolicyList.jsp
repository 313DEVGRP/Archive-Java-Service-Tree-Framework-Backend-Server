                      ...
                      <tr>
					    <td nowrap="nowrap">
					        <form name="item" method="post" action="<c:url value='/uat/uap/getLoginPolicy.do'/>">
					            ...
					            -->
					            <!-- a href="#LINK" onclick="javascript:fncSelectLoginPolicy('<c:out value="${loginPolicy.emplyrId}"/>'); return false;" style="selector-dummy:expression(this.hideFocus=false);"><c:out value="${loginPolicy.emplyrId}"/></a> -->
