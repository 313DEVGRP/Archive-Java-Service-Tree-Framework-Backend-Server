                ...
                <form name="frm" method="post">
                    ...
                    <table width="100%" cellpadding="8" class="table-search" border="0">
                        <tr>
                            <td width="40%" class="title_left">
                                <img src="<c:url value='/images/egovframework/com/cop/com/icon/tit_icon.gif' />"
                                     width="16" height="16" hspace="3" align="absmiddle" alt="">
                                &nbsp;게시판 사용정보 조회
                            </td>
                            <th>
                            </th>
                            <td width="10%">
                                <select name="searchCnd" title="검색조건선택" class="select">
                                    ...
                                    <option value="0"
                                            <c:if test="${searchVO.searchCnd == '0'}">selected="selected"</c:if> >사용자명
                                    </option>
                                </select>
                            </td>
                            <td width="35%">
                                <input name="searchWrd" title="검색어" type="text" size="35"
                            ...
                            <th width="10%">
                                <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td><img
                                                src="<c:url value='/images/egovframework/com/cop/com/btn/bu2_left.gif' />"
                                                width="8" height="20" alt="button left"></td>
                                        <td background="<c:url value='/images/egovframework/com/cop/com/btn/bu2_bg.gif'/>"
                                            class="text_left" nowrap="nowrap">
                                            <a href="<c:url value='/cop/com/selectCmyBBSUseInfsByTrget.do'/>"
                                               onclick="javascript:fn_egov_select_bbsUseInfs('1'); return false;">조회</a>
                                        </td>
                                        <td><img
                                                src="<c:url value='/images/egovframework/com/cop/com/btn/bu2_right.gif'/>"
                                                width="8" height="20" alt="button right"></td>
                                    </tr>
                                </table>
                            </th>
                        </tr>
                    ...
                    <table width="100%" cellpadding="8" class="table-line">
                        ...
                        <c:forEach var="result" items="${resultList}" varStatus="status">
                            <tr>
                                <td class="lt_text3" nowrap="nowrap"><c:out
                                ...
                                <c:choose>
                                    <c:when test="${result.useAt=='Y'}">
                                        ...
                                        <td class="lt_text3" nowrap="nowrap">
                                            <input type="button" value="사용중지"
                                                   onClick="javascript:fn_egov_delete_bbsUseInf('<c:out
                                                           value="${result.bbsId}"/>','<c:out
                                                           value="${result.trgetId}"/>');"/>
                                        </td>
                                    </c:when>
                                    <c:when test="${result.useAt=='N'}">
                                        ...
                                        <td class="lt_text3" nowrap="nowrap">
                                            <input type="button" value="사용"
                                                   onClick="javascript:fn_egov_update_bbsUseInf('<c:out
                                                           value="${result.bbsId}"/>','<c:out
                                                           value="${result.trgetId}"/>');"/>
                                        </td>
                                    </c:when>
                                    <c:otherwise>
                                        ...
                                        <td class="lt_text3" nowrap="nowrap">
                                            <input type="button" value="사용"
                                                   onClick="javascript:fn_egov_insert_bbsUseInf('<c:out
                                                           value="${result.bbsId}"/>','<c:out
                                                           value="${result.trgetId}"/>');"/>
                                        </td>
                                    </c:otherwise>
