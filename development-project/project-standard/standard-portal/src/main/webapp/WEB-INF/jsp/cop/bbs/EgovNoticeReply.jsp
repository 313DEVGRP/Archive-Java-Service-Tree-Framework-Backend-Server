                        ...
                        <div class="search_top_table">
                            <table>
                                <tr>
                                    ...
                                    <td class="td_content">
                                        <input id="nttSj" name="nttSj" type="text" size="60"
                                ...
                                <tr>
                                    <td class="td_width"><LABEL for="nttCn"><spring:message code="cop.nttCn"/></LABEL>
                                        <img src="<c:url value='/'/>images/required.gif" alt="필수항목" title="필수항목"
                                             width="15" height="15"/></td>
                                    <td class="td_content">
                                        <textarea id="nttCn" name="nttCn" class="textarea" cols="95"
                                                  rows="28"></textarea>
                                ...
                                <c:if test="${bdMstr.bbsAttrbCode == 'BBSA01'}">
                                    <tr>
                                        ...
                                        <td class="td_content">
                                            ...
                                            <input name="ntceBgndeView" title="게시시작일" type="text" size="10" value=""
                                                   readonly="readonly"
                                            ...
                                            <input name="ntceEnddeView" title="게시종료일" type="text" size="10" value=""
                                                   readonly="readonly"
