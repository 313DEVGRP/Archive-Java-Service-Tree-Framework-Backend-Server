        ...
        <div id="middle_content">
            ...
            <div id="content_field"><!--contents start-->
                ...
                <form name="frm" action="<c:url value='/cop/bbs${prefix}/selectBoardList.do'/>" method="post">
                    ...
                    <input type="submit" value="실행" onclick="fn_egov_select_noticeList('1'); return false;"
                        ...
                        <div class="search_area">
                            <div class="search_conditions">
                                <select name="searchCnd" class="select" title="검색조건 선택">
                                    <option value="0"
                                            <c:if test="${searchVO.searchCnd == '0'}">selected="selected"</c:if> >제목
                                    </option>
                                    <option value="1"
                                            <c:if test="${searchVO.searchCnd == '1'}">selected="selected"</c:if> >내용
                                    </option>
                                    <option value="2"
                                            <c:if test="${searchVO.searchCnd == '2'}">selected="selected"</c:if> >작성자
                                    </option>
                                </select>
                                <input name="searchWrd" type="text" size="35"
                            ...
                            <div class="search_buttons">
                                ...
                                <c:if test="${brdMstrVO.authFlag == 'Y'}">
                                    <a href="<c:url value='/cop/bbs${prefix}/addBoardArticle.do?bbsId=${boardVO.bbsId}'/>"><spring:message
