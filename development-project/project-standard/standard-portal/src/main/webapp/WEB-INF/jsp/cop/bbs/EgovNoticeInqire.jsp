				         ...
				         -->
                                ...
                                <tr>
                                    ...
                                    <td class="td_width" colspan="5">
                                        <textarea id="nttCn" name="nttCn" class="textarea" cols="95" rows="28"
                                                  readonly="readonly" title="글내용"><c:out value="${result.nttCn}"
                                ...
                                <c:if test="${anonymous == 'true'}">
                                    <tr>
                                        <td class="td_width"><label for="password"><spring:message
                                                code="cop.password"/></label></td>
                                        <td class="td_content" colspan="5">
                                            <input name="password" title="암호" type="password" size="20" value=""
                                                   maxlength="20">
                                        </td>
                                    </tr>
                                </c:if>
