            ...
            <div class="container bm-medium">
                <div class="one-whole">
                    <div class="text-center">
                        <h1 class="bm-remove">Rival War Notice Controller</h1>
                    </div>
                </div>
            </div>
        </nav>
                        ...
                        <div class="article-body rte" itemprop="articleBody">
                            <div id="description">
                                <div id="mmenu" style="clear: both;" class="clearfix">
                                    <div class="desktop-tablet alpha boxed bm-remove btn_wrap01">
                                        ...
                                        <button type="button" id="analyze" title="analyze"
                                                onclick="$('#alog').load('${pageContext.request.contextPath}/rivalWar/api/notice/analyzeNode.do');">
                                ...
                                <script type="text/javascript">
                                    function jstreeDataTableReload() {
                                        $('#jstreeTable').dataTable({
                                            "ajax": {
                                                "url": "${pageContext.request.contextPath}/api/rivalWar/notice/getMonitor.do",
                                                "dataSrc": ""
                                            },
                                            "destroy": true,
                                            "processing": true,
                                ...
                                <customTags:jstree target="#demo"
                                                   getChildNode="${pageContext.request.contextPath}/api/rivalWar/notice/getChildNode.do"
                                                   searchNode="${pageContext.request.contextPath}/api/rivalWar/notice/searchNode.do"
                                                   addNode="${pageContext.request.contextPath}/api/rivalWar/ROLE_ADMIN/notice/addNode.do"
                                                   removeNode="${pageContext.request.contextPath}/api/rivalWar/ROLE_ADMIN/notice/removeNode.do"
                                                   alterNode="${pageContext.request.contextPath}/api/rivalWar/ROLE_ADMIN/notice/alterNode.do"
                                                   alterNodeType="${pageContext.request.contextPath}/api/rivalWar/ROLE_ADMIN/notice/alterNodeType.do"
                                                   moveNode="${pageContext.request.contextPath}/api/rivalWar/ROLE_ADMIN/notice/moveNode.do">
                                </customTags:jstree>
                            </div>
                        </div>
                    </div>
