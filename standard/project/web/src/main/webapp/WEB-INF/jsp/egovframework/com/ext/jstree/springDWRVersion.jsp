			...
			<article>
				<div class="clearfix">
                    ...
                    <customTags:jstree target="#demo"
                                       getChildNode="${pageContext.request.contextPath}/com/ext/jstree/springiBatis/core/getChildNode.do"
                                       ...
                                       moveNode="${pageContext.request.contextPath}/com/ext/jstree/springiBatis/core/moveNode.do">
                    </customTags:jstree>
								</div>
							</div>
						</div>
