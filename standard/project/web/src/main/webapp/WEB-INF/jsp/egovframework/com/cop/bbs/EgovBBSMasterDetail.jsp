...
<div class="wTableFrm">
	...
	<tbody>
		...
		<!-- 게시판 소개내용 -->
		<tr>
			<th class="vtop"><spring:message code="comCopBbs.boardMasterVO.detail.bbsIntrcn" /></th>
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/cop/bbs/selectBBSMasterInfs.do' /><c:if test='${result.cmmntyId != null}'>?cmmntyId=${result.cmmntyId}</c:if>"  title="<spring:message code="title.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
