...
<head>
    ...
    <customTags:assetsJsExtendNas
            theRestOfFileName="/DataTables-1.10.16/extensions/Responsive/js/dataTables.responsive.js"></customTags:assetsJsExtendNas>
            ...
            <div class="container bm-medium">
                <div class="one-whole">
                    <div class="text-center">
                        <h1 class="bm-remove">Rival War specHashTag Controller</h1>
                    </div>
                </div>
            </div>
        </nav>
                        ...
                        <div class="article-body rte" itemprop="articleBody">
                            <div id="description">
                                <div id="mmenu" style="clear: both;" class="clearfix">
                                    <div class="desktop-tablet alpha boxed bm-remove btn_wrap01">
                                        ...
                                        <button type="button" id="analyze" title="analyze"
                                                onclick="$('#alog').load('${pageContext.request.contextPath}/api/rivalWar/specHashTag/analyzeNode.do');">
                                ...
                                <script type="text/javascript">
                                    function jstreeDataTableReload() {
                                        var jstreeDataTable = $('#jstreeTable').dataTable({
                                            "ajax": {
                                                "url": "${pageContext.request.contextPath}/api/rivalWar/specHashTag/monitor/list.do",
                                                "dataSrc": "rows"
                                            },
                                            "processing": true,
                                            "responsive": true,
                                ...
                                <customTags:jstree target="#demo"
                                                   getChildNode="${pageContext.request.contextPath}/api/rivalWar/specHashTag/getChildNode.do"
                                                   searchNode="${pageContext.request.contextPath}/api/rivalWar/specHashTag/searchNode.do"
                                                   addNode="${pageContext.request.contextPath}/api/rivalWar/ROLE_ADMIN/specHashTag/addNode.do"
                                                   removeNode="${pageContext.request.contextPath}/api/rivalWar/ROLE_ADMIN/specHashTag/removeNode.do"
                                                   alterNode="${pageContext.request.contextPath}/api/rivalWar/ROLE_ADMIN/specHashTag/alterNode.do"
                                                   alterNodeType="${pageContext.request.contextPath}/api/rivalWar/ROLE_ADMIN/specHashTag/alterNodeType.do"
                                                   moveNode="${pageContext.request.contextPath}/api/rivalWar/ROLE_ADMIN/specHashTag/moveNode.do"></customTags:jstree>
                            </div>
                        </div>
                    </div>
                </div>
