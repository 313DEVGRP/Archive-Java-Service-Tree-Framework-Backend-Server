            ...
            <div class="container bm-medium">
                <div class="one-whole">
                    <div class="text-center">
                        <h1 class="bm-remove">Rival War userSelectedItem Controller</h1>
                    </div>
                </div>
            </div>
        </nav>
                        ...
                        <div class="article-body rte" itemprop="articleBody">
                            <div id="description">
                                ...
                                <script type="text/javascript">
                                    function jstreeDataTableReload() {
                                        $('#jstreeTable').dataTable({
                                            "ajax": {
                                                "url": "${pageContext.request.contextPath}/api/rivalWar/userSelectedItem/getMonitor.do",
                                                "dataSrc": ""
                                            },
                                            "destroy": true,
                                            "processing": true,
                                ...
                                <customTags:jstree target="#demo"
                                                   getChildNode="${pageContext.request.contextPath}/api/rivalWar/userSelectedItem/getChildNode.do"
                                                   searchNode="${pageContext.request.contextPath}/api/rivalWar/userSelectedItem/searchNode.do"
                                                   addNode="${pageContext.request.contextPath}/api/rivalWar/ROLE_ADMIN/userSelectedItem/addNode.do"
                                                   removeNode="${pageContext.request.contextPath}/api/rivalWar/ROLE_ADMIN/userSelectedItem/removeNode.do"
                                                   alterNode="${pageContext.request.contextPath}/api/rivalWar/ROLE_ADMIN/userSelectedItem/alterNode.do"
                                                   alterNodeType="${pageContext.request.contextPath}/api/rivalWar/ROLE_ADMIN/userSelectedItem/alterNodeType.do"
                                                   moveNode="${pageContext.request.contextPath}/api/rivalWar/ROLE_ADMIN/userSelectedItem/moveNode.do"></customTags:jstree>
                            </div>
                        </div>
                    </div>
                </div>
