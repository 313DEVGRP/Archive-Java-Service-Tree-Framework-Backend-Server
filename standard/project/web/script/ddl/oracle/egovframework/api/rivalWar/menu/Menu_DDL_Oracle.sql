...
(
 ...
 AGGREGATE_RESULT_ID    NUMBER,
 COMPARE_INFO_ID        NUMBER,
 COMPARE_SPEC_ID        NUMBER,
...
COMMENT ON COLUMN T_JSTREE_MENU.AGGREGATE_RESULT_ID IS '누적집계 결과 아이디';
COMMENT ON COLUMN T_JSTREE_MENU.COMPARE_INFO_ID IS '비교 현황 정보 아이디';
COMMENT ON COLUMN T_JSTREE_MENU.COMPARE_SPEC_ID IS '비교 스펙 정보 아이디';
COMMENT ON COLUMN T_JSTREE_MENU.COMPARE_ITEM_ID IS '비교 스펙 아이템 아이디 onetomany';
