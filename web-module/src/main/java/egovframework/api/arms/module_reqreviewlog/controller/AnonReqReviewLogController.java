...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-anon/api/arms/reqReviewLog"})
public class AnonReqReviewLogController extends SHVAbstractController<ReqReviewLog, ReqReviewLogDTO> {
