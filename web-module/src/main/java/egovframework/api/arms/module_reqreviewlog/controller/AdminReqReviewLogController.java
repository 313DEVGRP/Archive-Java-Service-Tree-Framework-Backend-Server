...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-admin/api/arms/reqReviewLog"})
public class AdminReqReviewLogController extends SHVAbstractController<ReqReviewLog, ReqReviewLogDTO> {
