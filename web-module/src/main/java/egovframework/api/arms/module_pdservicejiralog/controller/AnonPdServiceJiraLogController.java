...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-anon/api/arms/pdServiceJiraLog"})
public class AnonPdServiceJiraLogController extends SHVAbstractController<PdServiceJiraLog, PdServiceJiraLogDTO> {
