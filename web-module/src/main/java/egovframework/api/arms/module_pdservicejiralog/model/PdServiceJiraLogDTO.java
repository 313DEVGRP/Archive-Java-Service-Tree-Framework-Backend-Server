...
@Entity
@Table(name = "T_ARMS_PDSERVICEJIRA_LOG")
@SelectBeforeUpdate(value=true)
@DynamicInsert(value=true)
@DynamicUpdate(value=true)
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SequenceGenerator(name = "JsTreeSequence", sequenceName = "S_T_ARMS_PDSERVICEJIRA_LOG", allocationSize = 1)
public class PdServiceJiraLogDTO extends JsTreeHibernateLogDTO implements Serializable {
