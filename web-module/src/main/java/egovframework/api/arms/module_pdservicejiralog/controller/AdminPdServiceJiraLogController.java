...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-admin/api/arms/pdServiceJiraLog"})
public class AdminPdServiceJiraLogController extends SHVAbstractController<PdServiceJiraLog, PdServiceJiraLogDTO> {
