...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-anon/api/arms/pdServiceVersion"})
public class AnonPdServiceVersionController extends SHVAbstractController<PdServiceVersion, PdServiceVersionDTO> {
