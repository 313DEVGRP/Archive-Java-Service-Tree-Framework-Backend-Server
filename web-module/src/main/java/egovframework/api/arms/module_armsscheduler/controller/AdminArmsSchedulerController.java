...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-admin/api/arms/armsScheduler"})
public class AdminArmsSchedulerController extends SHVAbstractController<ArmsScheduler, ArmsSchedulerDTO> {
