...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-admin/api/arms/pdServiceJiraPri"})
public class AdminPdServiceJiraPriController extends SHVAbstractController<PdServiceJiraPri, PdServiceJiraPriDTO> {
