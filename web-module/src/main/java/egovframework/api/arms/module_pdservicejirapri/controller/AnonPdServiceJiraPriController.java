...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-anon/api/arms/pdServiceJiraPri"})
public class AnonPdServiceJiraPriController extends SHVAbstractController<PdServiceJiraPri, PdServiceJiraPriDTO> {
