...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-user/api/arms/analpdrelease"})
public class UserAnalPdReleaseController extends SHVAbstractController<AnalPdRelease, AnalPdReleaseDTO> {
