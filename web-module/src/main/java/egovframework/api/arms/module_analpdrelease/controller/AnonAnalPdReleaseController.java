...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-anon/api/arms/analpdrelease"})
public class AnonAnalPdReleaseController extends SHVAbstractController<AnalPdRelease, AnalPdReleaseDTO> {
