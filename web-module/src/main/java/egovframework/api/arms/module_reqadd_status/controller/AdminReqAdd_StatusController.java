...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-admin/api/arms/reqAdd_Status"})
public class AdminReqAdd_StatusController extends SHVAbstractController<ReqAdd_Status, ReqAdd_StatusDTO> {
