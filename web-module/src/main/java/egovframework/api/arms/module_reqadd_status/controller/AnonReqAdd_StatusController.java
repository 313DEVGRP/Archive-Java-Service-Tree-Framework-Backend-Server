...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-anon/api/arms/reqAdd_Status"})
public class AnonReqAdd_StatusController extends SHVAbstractController<ReqAdd_Status, ReqAdd_StatusDTO> {
