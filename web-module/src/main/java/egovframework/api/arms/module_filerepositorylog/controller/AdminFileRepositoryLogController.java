...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-admin/api/arms/fileRepositoryLog"})
public class AdminFileRepositoryLogController extends SHVAbstractController<FileRepositoryLog, FileRepositoryLogDTO> {
