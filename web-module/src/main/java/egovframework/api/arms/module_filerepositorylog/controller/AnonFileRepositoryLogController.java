...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-anon/api/arms/fileRepositoryLog"})
public class AnonFileRepositoryLogController extends SHVAbstractController<FileRepositoryLog, FileRepositoryLogDTO> {
