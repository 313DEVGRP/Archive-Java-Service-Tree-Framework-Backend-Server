...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-admin/api/arms/pdServiceLog"})
public class AdminPdServiceLogController extends SHVAbstractController<PdServiceLog, PdServiceLogDTO> {
