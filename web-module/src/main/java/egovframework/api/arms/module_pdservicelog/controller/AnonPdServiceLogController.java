...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-anon/api/arms/pdServiceLog"})
public class AnonPdServiceLogController extends SHVAbstractController<PdServiceLog, PdServiceLogDTO> {
