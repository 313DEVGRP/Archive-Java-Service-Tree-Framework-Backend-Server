...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-user/api/arms/jiraIssuePriority"})
public class UserJiraIssuePriorityController extends SHVAbstractController<JiraIssuePriority, JiraIssuePriorityDTO> {
