...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-anon/api/arms/jiraIssuePriority"})
public class AnonJiraIssuePriorityController extends SHVAbstractController<JiraIssuePriority, JiraIssuePriorityDTO> {
