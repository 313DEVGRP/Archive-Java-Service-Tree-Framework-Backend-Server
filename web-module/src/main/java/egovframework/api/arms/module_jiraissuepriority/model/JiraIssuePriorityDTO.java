 ...
 * </pre>
 */
package egovframework.api.arms.module_jiraissuepriority.model;
...
@SequenceGenerator(name = "JsTreeSequence", sequenceName = "S_T_ARMS_JIRAISSUEPRIORITY", allocationSize = 1)
public class JiraIssuePriorityDTO extends JsTreeHibernateSearchDTO implements Serializable {

    public JiraIssuePriorityDTO() {
        super();
    }

    public JiraIssuePriorityDTO(Boolean copyBooleanValue) {
        super();
