...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-anon/api/arms/reqCommentLog"})
public class AnonReqCommentLogController extends SHVAbstractController<ReqCommentLog, ReqCommentLogDTO> {
