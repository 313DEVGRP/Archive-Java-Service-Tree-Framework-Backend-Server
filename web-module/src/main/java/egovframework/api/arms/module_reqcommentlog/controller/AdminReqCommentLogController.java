...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-admin/api/arms/reqCommentLog"})
public class AdminReqCommentLogController extends SHVAbstractController<ReqCommentLog, ReqCommentLogDTO> {
