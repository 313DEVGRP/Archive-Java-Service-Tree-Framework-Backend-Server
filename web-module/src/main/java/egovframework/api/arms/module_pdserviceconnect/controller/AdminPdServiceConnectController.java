...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-admin/api/arms/pdServiceConnect"})
public class AdminPdServiceConnectController extends SHVAbstractController<PdServiceConnect, PdServiceConnectDTO> {
