...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-anon/api/arms/pdServiceConnect"})
public class AnonPdServiceConnectController extends SHVAbstractController<PdServiceConnect, PdServiceConnectDTO> {
