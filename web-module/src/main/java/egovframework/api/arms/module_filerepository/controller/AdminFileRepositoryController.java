...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-admin/api/arms/fileRepository"})
public class AdminFileRepositoryController extends SHVAbstractController<FileRepository, FileRepositoryDTO> {
