...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-user/api/arms/jiraIssueStateLog"})
public class UserJiraIssueStateLogController extends SHVAbstractController<JiraIssueStateLog, JiraIssueStateLogDTO> {
