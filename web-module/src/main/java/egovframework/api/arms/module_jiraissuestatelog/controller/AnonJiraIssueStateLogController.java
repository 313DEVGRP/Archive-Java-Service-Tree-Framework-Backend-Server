...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-anon/api/arms/jiraIssueStateLog"})
public class AnonJiraIssueStateLogController extends SHVAbstractController<JiraIssueStateLog, JiraIssueStateLogDTO> {
