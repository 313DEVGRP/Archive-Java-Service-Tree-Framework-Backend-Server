...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-admin/api/arms/pdServiceJiraVer"})
public class AdminPdServiceJiraVerController extends SHVAbstractController<PdServiceJiraVer, PdServiceJiraVerDTO> {
