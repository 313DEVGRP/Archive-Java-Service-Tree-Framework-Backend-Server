...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-anon/api/arms/pdServiceJiraVer"})
public class AnonPdServiceJiraVerController extends SHVAbstractController<PdServiceJiraVer, PdServiceJiraVerDTO> {
