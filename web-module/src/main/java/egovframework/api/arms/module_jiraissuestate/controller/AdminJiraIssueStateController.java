...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-admin/api/arms/jiraIssueState"})
public class AdminJiraIssueStateController extends SHVAbstractController<JiraIssueState, JiraIssueStateDTO> {
