...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-anon/api/arms/jiraIssueState"})
public class AnonJiraIssueStateController extends SHVAbstractController<JiraIssueState, JiraIssueStateDTO> {
