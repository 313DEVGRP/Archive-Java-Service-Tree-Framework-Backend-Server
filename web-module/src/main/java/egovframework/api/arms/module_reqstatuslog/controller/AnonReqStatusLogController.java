...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-anon/api/arms/reqStatusLog"})
public class AnonReqStatusLogController extends SHVAbstractController<ReqStatusLog, ReqStatusLogDTO> {
