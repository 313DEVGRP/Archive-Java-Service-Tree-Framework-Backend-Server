...
@Getter
@Setter
@Table(name = "T_ARMS_REQSTATUS_LOG")
@SelectBeforeUpdate(value=true)
@DynamicInsert(value=true)
@DynamicUpdate(value=true)
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SequenceGenerator(name = "JsTreeSequence", sequenceName = "S_T_ARMS_REQSTATUS_LOG", allocationSize = 1)
public class ReqStatusLogDTO extends JsTreeHibernateLogDTO implements Serializable {
    ...
    public ReqStatusLogDTO(Boolean copyBooleanValue) {
        super();
