...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-user/api/arms/reqStatusLog"})
public class UserReqStatusLogController extends SHVAbstractController<ReqStatusLog, ReqStatusLogDTO> {
