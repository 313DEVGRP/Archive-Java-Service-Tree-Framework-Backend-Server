...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-admin/api/arms/pdServiceJiraPriLog"})
public class AdminPdServiceJiraPriLogController extends SHVAbstractController<PdServiceJiraPriLog, PdServiceJiraPriLogDTO> {
