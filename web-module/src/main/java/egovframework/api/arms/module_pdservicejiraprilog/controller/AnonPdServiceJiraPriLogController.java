...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-anon/api/arms/pdServiceJiraPriLog"})
public class AnonPdServiceJiraPriLogController extends SHVAbstractController<PdServiceJiraPriLog, PdServiceJiraPriLogDTO> {
