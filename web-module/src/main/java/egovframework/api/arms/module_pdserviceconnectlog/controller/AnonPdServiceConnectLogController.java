...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-anon/api/arms/pdServiceConnectLog"})
public class AnonPdServiceConnectLogController extends SHVAbstractController<PdServiceConnectLog, PdServiceConnectLogDTO> {
