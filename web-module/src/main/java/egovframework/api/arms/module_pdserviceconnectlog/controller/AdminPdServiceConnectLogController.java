...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-admin/api/arms/pdServiceConnectLog"})
public class AdminPdServiceConnectLogController extends SHVAbstractController<PdServiceConnectLog, PdServiceConnectLogDTO> {
