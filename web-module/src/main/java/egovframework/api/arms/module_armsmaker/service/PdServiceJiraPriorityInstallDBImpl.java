...
@Service("pdServiceJiraPriorityInstallDB")
public class PdServiceJiraPriorityInstallDBImpl extends CoreServiceImpl implements ArmsInstallDB{
    ...
    private void makeTrigger(ComprehensiveTree comprehensiveTree) throws SQLException {
        ...
        String addColums =",c_jirapriority_id, c_jirapriority_desc, c_jirapriority_name, c_jirapriority_link";
        String addOldColums =",:old.c_jirapriority_id,:old.c_jirapriority_desc,:old.c_jirapriority_name,:old.c_jirapriority_link";
        String addNewColums =",:new.c_jirapriority_id,:new.c_jirapriority_desc,:new.c_jirapriority_name,:new.c_jirapriority_link";
