...
@Service("reqCommentInstallDB")
public class ReqCommentInstallDBImpl extends CoreServiceImpl implements ArmsInstallDB {
    ...
    private void makeTrigger(ComprehensiveTree comprehensiveTree) throws SQLException {
        ...
        String addColums =",c_pdservice_link,c_version_link,c_jira_link,c_jira_ver_link,c_req_link,c_review_link,c_sender,c_comment_date,c_comment";
        String addOldColums =",:old.c_pdservice_link,:old.c_version_link,:old.c_jira_link,:old.c_jira_ver_link,:old.c_req_link,:old.c_review_link,:old.c_sender,:old.c_comment_date,:old.c_comment";
        String addNewColums =",:new.c_pdservice_link,:new.c_version_link,:new.c_jira_link,:new.c_jira_ver_link,:new.c_req_link,:new.c_review_link,:new.c_sender,:new.c_comment_date,:new.c_comment";
