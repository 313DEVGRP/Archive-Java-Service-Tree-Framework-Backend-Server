...
public class ReqStatusTemplateInstallDBImpl extends CoreServiceImpl implements ArmsInstallDB{
    ...
    private void makeTrigger(ComprehensiveTree comprehensiveTree) throws SQLException {
        ...
        String addColums =",c_pdservice_link,c_version_link,c_jira_link,c_req_link,c_jira_version_link,c_jira_req_link,c_jira_req_linkingissue,c_jira_req_subtaskissue";
        String addOldColums =",:old.c_pdservice_link,:old.c_version_link,:old.c_jira_link,:old.c_req_link,:old.c_jira_version_link,:old.c_jira_req_link,:old.c_jira_req_linkingissue,:old.c_jira_req_subtaskissue";
        String addNewColums =",:new.c_pdservice_link,:new.c_version_link,:new.c_jira_link,:new.c_req_link,:new.c_jira_version_link,:new.c_jira_req_link,:new.c_jira_req_linkingissue,:new.c_jira_req_subtaskissue";
