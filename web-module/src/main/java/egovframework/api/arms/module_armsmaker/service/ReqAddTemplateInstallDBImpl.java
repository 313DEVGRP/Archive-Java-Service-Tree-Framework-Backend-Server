...
public class ReqAddTemplateInstallDBImpl extends CoreServiceImpl implements ArmsInstallDB{
    ...
    private void makeTrigger(ComprehensiveTree comprehensiveTree) throws SQLException {
        ...
        String addColums =",c_pdservice_link,c_pdservice_name,c_version_link,c_version_name,c_jira_project_link,c_jira_project_name,c_jira_version_link,c_jira_version_name,c_jira_req_issue_link,c_jira_req_issue_key,c_jira_req_priority_link,c_jira_req_priority_name,c_jira_req_status_link,c_jira_req_status_name,c_jira_req_linkingissue,c_jira_req_subtaskissue,c_reviewer01,c_reviewer02,c_reviewer03,c_reviewer04,c_reviewer05,c_reviewer01_status,c_reviewer02_status,c_reviewer03_status,c_reviewer04_status,c_reviewer05_status,c_writer,c_writer_date,c_contents";
        String addOldColums =",:old.c_pdservice_link,:old.c_pdservice_name,:old.c_version_link,:old.c_version_name,:old.c_jira_project_link,:old.c_jira_project_name,:old.c_jira_version_link,:old.c_jira_version_name,:old.c_jira_req_issue_link,:old.c_jira_req_issue_key,:old.c_jira_req_priority_link,:old.c_jira_req_priority_name,:old.c_jira_req_status_link,:old.c_jira_req_status_name,:old.c_jira_req_linkingissue,:old.c_jira_req_subtaskissue,:old.c_reviewer01,:old.c_reviewer02,:old.c_reviewer03,:old.c_reviewer04,:old.c_reviewer05,:old.c_reviewer01_status,:old.c_reviewer02_status,:old.c_reviewer03_status,:old.c_reviewer04_status,:old.c_reviewer05_status,:old.c_writer,:old.c_writer_date,:old.c_contents";
        String addNewColums =",:new.c_pdservice_link,:new.c_pdservice_name,:new.c_version_link,:new.c_version_name,:new.c_jira_project_link,:new.c_jira_project_name,:new.c_jira_version_link,:new.c_jira_version_name,:new.c_jira_req_issue_link,:new.c_jira_req_issue_key,:new.c_jira_req_priority_link,:new.c_jira_req_priority_name,:new.c_jira_req_status_link,:new.c_jira_req_status_name,:new.c_jira_req_linkingissue,:new.c_jira_req_subtaskissue,:new.c_reviewer01,:new.c_reviewer02,:new.c_reviewer03,:new.c_reviewer04,:new.c_reviewer05,:new.c_reviewer01_status,:new.c_reviewer02_status,:new.c_reviewer03_status,:new.c_reviewer04_status,:new.c_reviewer05_status,:new.c_writer,:new.c_writer_date,:new.c_contents";
