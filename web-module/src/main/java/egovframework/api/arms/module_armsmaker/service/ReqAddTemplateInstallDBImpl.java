...
public class ReqAddTemplateInstallDBImpl extends CoreServiceImpl implements ArmsInstallDB{
    ...
    private void makeTrigger(ComprehensiveTree comprehensiveTree) throws SQLException {
        ...
        String addColums =",C_PDSERVICE_LINK,C_VERSION_LINK,C_JIRA_LINK,C_ISSUE_LINK,C_REVIEWER01,C_REVIEWER01_STATUS,C_REVIEWER02,C_REVIEWER02_STATUS,C_REVIEWER03,C_REVIEWER03_STATUS,C_REVIEWER04,C_REVIEWER04_STATUS,C_REVIEWER05,C_REVIEWER05_STATUS,C_WRITER,C_WRITER_DATE,C_PRIORITY,C_REQ_STATUS,C_CONTENTS";
        String addOldColums =",:old.C_PDSERVICE_LINK,:old.C_VERSION_LINK,:old.C_JIRA_LINK,:old.C_ISSUE_LINK,:old.C_REVIEWER01,:old.C_REVIEWER01_STATUS,:old.C_REVIEWER02,:old.C_REVIEWER02_STATUS,:old.C_REVIEWER03,:old.C_REVIEWER03_STATUS,:old.C_REVIEWER04,:old.C_REVIEWER04_STATUS,:old.C_REVIEWER05,:old.C_REVIEWER05_STATUS,:old.C_WRITER,:old.C_WRITER_DATE,:old.C_PRIORITY,:old.C_REQ_STATUS,:old.C_CONTENTS";
        String addNewColums =",:new.C_PDSERVICE_LINK,:new.C_VERSION_LINK,:new.C_JIRA_LINK,:new.C_ISSUE_LINK,:new.C_REVIEWER01,:new.C_REVIEWER01_STATUS,:new.C_REVIEWER02,:new.C_REVIEWER02_STATUS,:new.C_REVIEWER03,:new.C_REVIEWER03_STATUS,:new.C_REVIEWER04,:new.C_REVIEWER04_STATUS,:new.C_REVIEWER05,:new.C_REVIEWER05_STATUS,:new.C_WRITER,:new.C_WRITER_DATE,:new.C_PRIORITY,:new.C_REQ_STATUS,:new.C_CONTENTS";
