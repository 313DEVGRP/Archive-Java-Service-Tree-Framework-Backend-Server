...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-anon/api/arms/pdServiceVersionLog"})
public class AnonPdServiceVersionLogController extends SHVAbstractController<PdServiceVersionLog, PdServiceVersionLogDTO> {
