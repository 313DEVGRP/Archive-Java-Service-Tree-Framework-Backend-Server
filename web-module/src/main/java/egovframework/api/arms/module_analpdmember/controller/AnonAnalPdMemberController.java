...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-anon/api/arms/analpdmember"})
public class AnonAnalPdMemberController extends SHVAbstractController<AnalPdMember, AnalPdMemberDTO> {
