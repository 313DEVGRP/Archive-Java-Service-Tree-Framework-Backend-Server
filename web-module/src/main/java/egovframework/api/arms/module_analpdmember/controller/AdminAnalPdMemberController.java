...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-admin/api/arms/analpdmember"})
public class AdminAnalPdMemberController extends SHVAbstractController<AnalPdMember, AnalPdMemberDTO> {
