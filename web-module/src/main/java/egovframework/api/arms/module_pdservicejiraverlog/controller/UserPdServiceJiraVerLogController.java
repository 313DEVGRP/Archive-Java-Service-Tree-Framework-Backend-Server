...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-user/api/arms/pdServiceJiraVerLog"})
public class UserPdServiceJiraVerLogController extends SHVAbstractController<PdServiceJiraVerLog, PdServiceJiraVerLogDTO> {
