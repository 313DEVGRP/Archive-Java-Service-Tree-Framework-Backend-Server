...
@Slf4j
@Controller
@RequestMapping(value = {"/auth-admin/api/arms/pdServiceJiraVerLog"})
public class AdminPdServiceJiraVerLogController extends SHVAbstractController<PdServiceJiraVerLog, PdServiceJiraVerLogDTO> {
