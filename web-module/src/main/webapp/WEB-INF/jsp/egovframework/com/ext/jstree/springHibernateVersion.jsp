				...
				<div class="container bm-medium">
					<div class="one-whole">
						<div class="text-center">
							<h1 class="bm-remove">jsTree Service Engine Spring Hibernate Version Demo</h1>
						</div>
					</div>
				</div>
			</nav>
								...
								<div id="description">
									<div id="mmenu" style="clear: both;" class="clearfix">
										<div class="desktop-tablet alpha boxed bm-remove btn_wrap01">
											...
											<button type="button" id="analyze" title="analyze" onclick="$('#alog').load('/com/ext/jstree/springHibernate/core/analyzeNode.do');">
                                    ...
                                    <script type="text/javascript">
                                        function jstreeDataTableReload() {
                                            $('#jstreeTable').dataTable({
                                                "ajax": {
                                                    "url": "${pageContext.request.contextPath}/com/ext/jstree/springHibernate/core/getMonitor.do",
                                                    "dataSrc": ""
                                                },
                                                "destroy": true,
                                                "processing": true,
                                    ...
                                    <customTags:jstree target="#demo"
                                                       getChildNode="${pageContext.request.contextPath}/com/ext/jstree/springHibernate/core/getChildNode.do"
                                                       searchNode="${pageContext.request.contextPath}/com/ext/jstree/springHibernate/core/searchNode.do"
                                                       addNode="${pageContext.request.contextPath}/com/ext/jstree/springHibernate/core/addNode.do"
                                                       removeNode="${pageContext.request.contextPath}/com/ext/jstree/springHibernate/core/removeNode.do"
                                                       alterNode="${pageContext.request.contextPath}/com/ext/jstree/springHibernate/core/alterNode.do"
                                                       alterNodeType="${pageContext.request.contextPath}/com/ext/jstree/springHibernate/core/alterNodeType.do"
                                                       moveNode="${pageContext.request.contextPath}/com/ext/jstree/springHibernate/core/moveNode.do">
                                    </customTags:jstree>
