package egovframework.com.jstree.support.util;

import egovframework.com.ext.jstree.support.util.*;
...
public class ParameterParser {
    ...
    public Date getEndDate(String name) {
        return egovframework.com.ext.jstree.support.util.DateUtils.addDays(getDate(name, new Date()), 1);
    }
    ...
    public Date getDate(String name, Date def) {
        ...
        try {
            return egovframework.com.ext.jstree.support.util.DateUtils.getDateFormat("yyyy-MM-dd").parse(temp);
        } catch (Exception e) {
            return def;
        }
    }
    ...
    public Date getDateTime(String name, Date def) {
        ...
        try {
            return egovframework.com.ext.jstree.support.util.DateUtils.getDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS").parse(temp);
        } catch (Exception e) {
            return def;
        }
    }
    ...
    public Date getDateSearchDate(int addHour) {
        ...
        return egovframework.com.ext.jstree.support.util.DateUtils.getDate(date);
    }
    ...
    public Date getDateStart(int day) {
        ...
        if (StringUtils.isEmpty(date1)) {
            ...
            date1 = egovframework.com.ext.jstree.support.util.DateUtils.getDateFormat("yyyy-MM-dd").format(temp);
        }
        String date = date1 + " 00:00:00";
        return egovframework.com.ext.jstree.support.util.DateUtils.getDate(date);
    }
    ...
    public Date getDateEnd() {
        ...
        if (StringUtils.isEmpty(date1)) {
            date1 = egovframework.com.ext.jstree.support.util.DateUtils.getDateFormat("yyyy-MM-dd").format(new Date());
        }
        String date = date1 + " 23:59:59.999";
        return egovframework.com.ext.jstree.support.util.DateUtils.getDate(date, "yyyy-MM-dd HH:mm:ss.SSS");
    }
    ...
    public Date getDateHour(String name, Date def) {
        ...
        try {
            return egovframework.com.ext.jstree.support.util.DateUtils.getDateFormat("yyyy-MM-dd HH:mm").parse(temp);
        } catch (Exception e) {
            return def;
        }
    }
